...
import { CreateFirstCard, ExamCard, QuestionBankCard, ResourceCarousel } from './resource-cards'
 ...
 * each section gets a quiet label rather than a title.
 */
    ...
    <AppShell crumbs={[{ label: 'Home' }]} persistentStorage={persistentStorage}>
      ...
      <section className="home-shelf" aria-labelledby="recent-exams-heading">
        {recentExams.length === 0 ? (
          <>
            ...
            <CreateFirstCard label="Create your first Exam" onClick={onNewExam} />
          </>
        ) : (
          <ResourceCarousel
            label="Recent Exams"
      ...
      <section className="home-shelf" aria-labelledby="question-banks-heading">
        <div className="shelf-bar">
          ...
          <button type="button" className="secondary-button" onClick={onNewBank}>
            New Question Bank
          </button>
        </div>
        {banks.length === 0 ? (
          <CreateFirstCard label="Create your first Question Bank" onClick={onNewBank} />
        ) : (
