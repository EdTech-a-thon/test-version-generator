...
1. **Content author is the target.** FormForge helps teachers write, reuse, and generate assessments. It intentionally includes no pre-authored question library.
